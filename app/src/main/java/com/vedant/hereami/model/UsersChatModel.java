package com.vedant.hereami.model;
...
public class UsersChatModel implements Parcelable {
    ...
    private UsersChatModel(Parcel parcelIn) {
        ...
        mlastmessage=parcelIn.readString();
        mmobileno=parcelIn.readString();
    }
    ...
    public void setMobileno(String mobileno){mmobileno=mobileno; }
    ...
    public String getMlastmessage(){return mlastmessage;}
