...
public class MyCustomHeadView extends LinearLayout implements CustomSwipeRefreshLayout.CustomSwipeRefreshHeadLayout {
    ...
    private void setupLayout() {
        ...
        mImageView = (ImageView) findViewById(com.vedant.hereami.R.id.default_header_arrow);
        mMainTextView = (TextView) findViewById(com.vedant.hereami.R.id.default_header_textview);
        mSubTextView = (TextView) findViewById(com.vedant.hereami.R.id.default_header_time);
        mProgressBar = (ProgressBar) findViewById(com.vedant.hereami.R.id.default_header_progressbar);
    }
