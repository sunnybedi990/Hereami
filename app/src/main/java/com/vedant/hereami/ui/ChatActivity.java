...
import vs.android.com.vs.adapter.MessageChatAdapter;
import vs.android.com.vs.model.MessageChatModel;
import vs.android.com.vs.model.UsersChatModel;
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildKey) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    //Notification notification= new Notification.Builder(getApplicationContext())
                      //      .setContentTitle(mRecipientUid)
                        //    .setContentText(mFirebaseMessagesChat.getAuth().getUid().toString())
                          //  .setSmallIcon(R.drawable.recipient_rounded_corners)
                   ...
                   // CharSequence appName =  getApplicationContext().getPackageManager().getApplicationLabel(getApplicationContext().getApplicationInfo());
                    ...
                    //notificationManager.notify((String)appName,9999,notification);
