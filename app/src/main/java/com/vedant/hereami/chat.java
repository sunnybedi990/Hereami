        ...
        fb_to_read.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot result) {
                ...
                for (DataSnapshot dsp : result.getChildren()) {
                    ...
                    ArrayAdapter<String> itemsAdapter = new ArrayAdapter<String>(chat.this, android.R.layout.simple_list_item_1, android.R.id.text1, lst);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent4 = new Intent(chat.this, TestActivity.class).putExtra("key_position", lst.get(position));
